"""  
Code imports modules and creates an active instance of the FastAPI
class named app
"""
...
#defines an endpoint in the FastAPI application to retrieve a list of all available courses.
#endpoint can be accessed when using an HTTP GET request to '/courses'
@app.get('/courses')
...
#Get a specified course using the id
...
#Get a specific chapter information endpoint
...
#rate chapter endpoint
#This allows users to rate individual chapters withn a course
